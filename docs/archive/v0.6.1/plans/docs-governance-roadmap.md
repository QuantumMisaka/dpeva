...
| 问题类型 | 具体表现 | 改进建议 | 优先级 |
| :--- | :--- | :--- | :--- |
| **冲突 (Conflict)** | `docs/reference/config_schema.md` 与 `src/dpeva/config.py` 脱节。 | **Sync**: 引入 Sphinx + Pydantic 插件自动生成文档。 | **P0** |
...
- [x] **Consolidation**: 废弃静态 `config_schema.md`，全面转向 Sphinx 生成的 API 文档。
