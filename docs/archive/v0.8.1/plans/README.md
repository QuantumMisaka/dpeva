...
- `2026-07-01-docs-audit-and-dpeva-operator-skill-plan.md`
...
- `2026-07-03-dataset-audit.md`
  ...
  - Status: archived
- `2026-07-03-slurm-array-backend.md`
  - Type: Backend Refactor Implementation Plan Snapshot
  - Status: archived
