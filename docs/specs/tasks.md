...
## Phase 4: Verification & Testing [PARTIAL]
- [ ] **Task 4.1**: Create unit tests for `AbacusGenerator` (geometry detection).
- [ ] **Task 4.2**: Create integration test using `test/fp-setting` data.
