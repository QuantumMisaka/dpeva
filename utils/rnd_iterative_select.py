...
for iter_ind in range(num_iter):
    ...
    if len(select_index) == 0:
        ...
        pool_desc_added = np.concatenate([desc_pool[int(i)] for i in select_index], axis=0)
