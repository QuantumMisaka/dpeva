...
- 找回丢失的物理维度 当前策略强制将所有结构描述符投影到单位球面上（模长恒为 1），这相当于人为抹去了“结构有序度”这一物理信息。
报告分析指出，模长 [ o bj ec tO bj ec t ] M 是一个有效的序参量（ [ o bj ec tO bj ec t ] M → 1 表示高度有序/一致， [ o bj ec tO bj ec t ] M → 0 表示高度无序/复杂）。保留这一维度有助于模型区分简单晶体和复杂缺陷结构，从而更合理地分配拟合能力。
- 力精度的损失可接受 虽然“仅原子归一化”在力的 RMSE 上略有增加（0.0964 [ o bj ec tO bj ec t ] → 0.0981 eV/Å，约 1.8%），但相对于能量精度的巨大提升，这一代价是微小且可接受的。
