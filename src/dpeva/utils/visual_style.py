...
def get_analysis_parity_profile(
    ...
    base_profile = {
        ...
        "enhanced": {
            ...
            "error_tick_pad": -3.0,
            "aligned_sidebar_gap": 0.032,
            "hexbin_aligned_sidebar_gap": 0.022,
        },
    }
    quantity_overrides = {
        "energy": {
        ...
        "force": {
            ...
            "enhanced": {
                ...
                "main_scatter_size": 14.0,
                "renderer_default": "hexbin",
                "main_density_mode": "hexbin",
                "main_density_gridsize": 60,
                "main_density_mincnt": 3,
                "main_density_cmap": "viridis",
                "main_density_norm": "power",
                "main_density_norm_gamma": 0.72,
                "main_overlay_scatter_enabled": True,
                "main_overlay_scatter_alpha": 0.13,
                "main_overlay_scatter_size": 5.8,
