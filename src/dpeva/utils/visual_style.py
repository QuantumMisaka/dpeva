...
def get_analysis_parity_profile(
    ...
    enhanced_fonts = scale_font_hierarchy(
        base_fonts,
        title_scale=1.20 * (18 / 16),
        label_scale=1.18 * (18 / 16),
        tick_scale=1.12 * (18 / 16),
        legend_scale=1.04 * (18 / 16),
        legend_title_scale=1.02 * (18 / 16),
    )
    panel_fonts = scale_font_hierarchy(
        base_fonts,
        title_scale=0.88 * (18 / 16),
        label_scale=0.92 * (18 / 16),
        tick_scale=0.88 * (18 / 16),
        legend_scale=0.9 * (18 / 16),
        legend_title_scale=0.9 * (18 / 16),
    )
    base_profile = {
        ...
        "enhanced": {
            ...
            "main_scatter_size": 20.0,
            "main_density_mode": "scatter",
            "main_density_gridsize": 50,
            ...
            "hexbin_wspace": 0.12,
            "hexbin_sidebar_height_ratios": [0.40, 0.70],
